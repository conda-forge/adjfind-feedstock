About adjfind-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/adjfind-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/zwang-geog/AdjFind
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=26939&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/adjfind-feedstock?branchName=main">
          </a>
        </summary>
        <table>
...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-adjfind-green.svg)](https://anaconda.org/conda-forge/adjfind) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/adjfind.svg)](https://anaconda.org/conda-forge/adjfind) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/adjfind.svg)](https://anaconda.org/conda-forge/adjfind) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/adjfind.svg)](https://anaconda.org/conda-forge/adjfind) |

Installing adjfind
==================

Installing `adjfind` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Once the `conda-forge` channel has been enabled, `adjfind` can be installed with `conda`:

```
conda install adjfind
```

or with `mamba`:

```
mamba install adjfind
```

It is possible to list all of the versions of `adjfind` available on your platform with `conda`:

```
conda search adjfind --channel conda-forge
```

or with `mamba`:

```
mamba search adjfind --channel conda-forge
```
...
mamba repoquery search adjfind --channel conda-forge

# List packages depending on `adjfind`:
mamba repoquery whoneeds adjfind --channel conda-forge

# List dependencies of `adjfind`:
mamba repoquery depends adjfind --channel conda-forge
```
...
Updating adjfind-feedstock
==========================

If you would like to improve the adjfind recipe or build a new
...
Note that all branches in the conda-forge/adjfind-feedstock are
...
* [@zwang-geog](https://github.com/zwang-geog/)
